...
function PersonalAccountUserScreen(): JSX.Element {
  return (
                ...
                <div className="personal-account-user">
                  ...
                  <div className="personal-account-user__info">
                    <a className="thumbnail-link thumbnail-link--theme-dark" href="#">
                      ...
                      </div><span className="thumbnail-link__text">Дневник тренировок</span>
                    </a>
                    <a className="thumbnail-link thumbnail-link--theme-dark" href="#">
                      <div className="thumbnail-link__icon thumbnail-link__icon--theme-dark">
                        <svg width="30" height="26" aria-hidden="true">
                      ...
                      </div><span className="thumbnail-link__text">Дневник питания</span>
                    </a>
                    <section className="my-progress personal-account-user__my-progress">
                      <div className="my-progress__sidebar">
                        ...
                        <ul className="my-progress__list">
                          ...
                          <li className="my-progress__item"><span>ушло,<br></br> Ккал</span></li>
                  ...
                  <div className="personal-account-user__additional-info">
                    ...
                    <a className="thumbnail-link thumbnail-link--theme-light" href="#">
                      ...
                      </div><span className="thumbnail-link__text">Мои залы</span>
                    </a>
...
export default PersonalAccountUserScreen;
