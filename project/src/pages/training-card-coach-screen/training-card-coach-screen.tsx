...
type TrainingCardCoachScreenProps ={
  trainingsScreenReviewsQty: number;
}

function TrainingCardCoachScreen({trainingsScreenReviewsQty}:TrainingCardCoachScreenProps ): JSX.Element{
  return(
...
export default TrainingCardCoachScreen;
