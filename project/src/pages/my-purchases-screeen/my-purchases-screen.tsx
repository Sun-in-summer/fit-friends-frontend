              ...
              <div className="my-purchases__title-wrapper">
                ...
                <div className="my-purchases__controls">
                  ...
                  <div className="btn-radio-sort">
                    <label>
                      <input type="radio" name="sort" checked/><span className="btn-radio-sort__label">Абонементы</span>
                    </label>
                    <label>
              ...
              <ul className="my-purchases__list">
                <li className="my-purchases__item">
                  <div className="thumbnail-gym">
                    <div className="thumbnail-gym__image">
                      <picture>
                        <source type="image/webp" srcSet="img/content/thumbnails/gym-04.webp, img/content/thumbnails/gym-04@2x.webp 2x"/><img src="img/content/thumbnails/gym-04.jpg" srcSet="img/content/thumbnails/gym-04@2x.jpg 2x" width="330" height="190" alt=""/>
                      </picture>
                    </div>
                ...
                <li className="my-purchases__item">
                  <div className="thumbnail-gym">
                    <div className="thumbnail-gym__image">
                      <picture>
                        <source type="image/webp" srcSet="img/content/thumbnails/gym-10.webp, img/content/thumbnails/gym-10@2x.webp 2x"/><img src="img/content/thumbnails/gym-10.jpg" srcSet="img/content/thumbnails/gym-10@2x.jpg 2x" width="330" height="190" alt=""/>
                      </picture>
                    </div>
                    <div className="thumbnail-gym__verified">
                      <svg width="14" height="14" aria-hidden="true">
                ...
                <li className="my-purchases__item">
                  <div className="thumbnail-gym">
                    <div className="thumbnail-gym__image">
                      <picture>
                        <source type="image/webp" srcSet="img/content/thumbnails/gym-12.webp, img/content/thumbnails/gym-12@2x.webp 2x"/><img src="img/content/thumbnails/gym-12.jpg" srcSet="img/content/thumbnails/gym-12@2x.jpg 2x" width="330" height="190" alt=""/>
                      </picture>
                    </div>
                    <div className="thumbnail-gym__verified">
                      <svg width="14" height="14" aria-hidden="true">
